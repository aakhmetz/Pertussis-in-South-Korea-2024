...
transformed parameters {
    ...
    vector[N_index_cases] exposure_raw_index_cases = exp(log_exposure_raw_index_cases); // raw exposures for index cases
...
model {
    ...
    target += gamma_lupdf(exposure[ID_infectee] - exposure[ID_infector] | param1_gentime, param2_gentime);
}
